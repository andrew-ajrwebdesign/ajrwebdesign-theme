 ...
 */
?>
<!-- wp:group {"tagName":"section","metadata":{"name":"Hero Section"},"className":"hero-section","gradient":"hero-dark","style":{"spacing":{"padding":{"top":"var:preset|spacing|70","bottom":"var:preset|spacing|70"}}},"layout":{"type":"constrained"}} -->
