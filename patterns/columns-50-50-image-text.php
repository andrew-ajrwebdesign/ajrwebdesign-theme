<?php
/**
 * Title: Two Columns — 50/50 Image + Text
 * Slug: ajrwebdesign/columns-50-50-image-text
 * Categories: columns
 * Description: Two equal columns with image on the left and text on the right.
 */
?>
