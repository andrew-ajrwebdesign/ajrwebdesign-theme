...
/**
 * Title: Case Studies
 * Slug: ajrwebdesign/case-studies-grid
 * Categories: featured
 * Description: Case study section intro followed by full-width case study cards.
 *
...
<p class="has-text-align-center has-muted-color has-text-color has-link-color" style="line-height:1.7">Every result below comes from focused WordPress performance, SEO, and technical improvements — showing the difference that cleaner code, faster load times, and better site foundations can make.</p>
<!-- /wp:paragraph --></section>
<!-- /wp:group -->

<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)"><!-- wp:ajrwebdesign-core/case-study-card {"caseStudyId":1514} /--></div>
<!-- /wp:group -->

<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|70","bottom":"var:preset|spacing|70"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)"><!-- wp:ajrwebdesign-core/case-study-card {"caseStudyId":1525,"layoutDirection":"text-left"} /--></div>
<!-- /wp:group -->
